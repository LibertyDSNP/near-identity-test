...
use near_sdk::{env, near_bindgen, Balance, Promise, PublicKey};
...
mod tests {
    ...
    fn create_and_transfer_account() {
        ...
        contract.generate_implicit_account_from_key("ed25519:2uy3CUJo3tB3fvDoozoenrYR2Ub4zQBVMx98VkjYpXue".to_string());
